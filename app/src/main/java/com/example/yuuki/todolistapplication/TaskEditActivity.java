...
public class TaskEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (taskId != -1) {
            ...
            RealmResults<Task> results = realm.where(Task.class).equalTo("id", taskId)
                    .findAll();
    ...
    public void onSaveTapped(View view){
        ...
        if (taskId != -1){
            ...
            Snackbar.make(findViewById(android.R.id.content), "更新しました",Snackbar
                    .LENGTH_SHORT).setAction("戻る", new View.OnClickListener() {
                @Override
    ...
    public void onDeleteTapped(View view){
        ...
        if (taskId != -1){
            ...
            realm.commitTransaction();
            Toast.makeText(this, "削除しました", Toast.LENGTH_SHORT)
                    .show();
        }
        finish();
    }
